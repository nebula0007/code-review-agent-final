import os
import sys
import time  # 👈 Added time module for the retry sleep
...
def call_endpoint(path, data=None):
    # Safely construct the URL to prevent double slashes (e.g., //reset)
    ...
    max_retries = 10  # 👈 Will try 10 times before completely failing
    ...
    for attempt in range(max_retries):
        ...
        # If we get here, all URLs failed on this attempt. Wait and try again.
